    ...
    <div class="card-body bg-white text-center rounded">
        ...
        <form class="flex flex-col items-center mb-5" wire:submit.prevent="submit">
            ...
            <input wire:model="detail" class="form-text w-2/4 py-2 px-4 rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:ring-opacity-50 mb-3" type="text" placeholder="Detail">
